...
public abstract class ParquetPushDownFilter extends StoragePluginOptimizerRule {
  public static StoragePluginOptimizerRule FILTER_ON_PROJECT = new ParquetPushDownFilter(
  ...
  public static StoragePluginOptimizerRule FILTER_ON_SCAN = new ParquetPushDownFilter(
