...
public class ScreenPrule extends RelOptRule{
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    DrillScreenRelBase newScreen = new ScreenPrel(screen.getCluster(), screen.getTraitSet().replace(Prel.DRILL_PHYSICAL).plus(DrillDistributionTrait.SINGLETON), convertedInput);
