...
public class SingleMergeExchangePrel extends SingleRel implements Prel {
  ...
  public SingleMergeExchangePrel(RelOptCluster cluster, RelTraitSet traitSet, RelNode input) {
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new SingleMergeExchangePrel(getCluster(), traitSet, sole(inputs));
  }
